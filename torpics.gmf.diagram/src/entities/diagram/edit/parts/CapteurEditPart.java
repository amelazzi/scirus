...
import entities.diagram.edit.policies.CapteurItemSemanticEditPolicy;
import entities.diagram.part.DefaultVisualIDRegistry;

/**
 * @generated
 */
public class CapteurEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public CapteurEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CapteurItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		FlowLayoutEditPolicy lep = new FlowLayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (DefaultVisualIDRegistry.getVisualID(childView)) {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof CapteurNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DefaultVisualIDRegistry
				.getType(CapteurNameEditPart.VISUAL_ID));
	}
