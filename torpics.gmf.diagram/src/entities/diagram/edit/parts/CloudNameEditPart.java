...
import entities.diagram.edit.policies.DefaultTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CloudNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DefaultTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return DefaultElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = DefaultParserProvider
					.getParser(
							...
							DefaultVisualIDRegistry
									.getType(entities.diagram.edit.parts.CloudNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					DefaultEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
