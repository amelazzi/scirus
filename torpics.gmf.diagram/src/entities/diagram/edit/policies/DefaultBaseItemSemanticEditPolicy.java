 ...
 * @generated
 */
public class DefaultBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected DefaultBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						DefaultVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = DefaultElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = DefaultDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			DefaultDiagramEditorPlugin.getInstance().setLinkConstraints(
