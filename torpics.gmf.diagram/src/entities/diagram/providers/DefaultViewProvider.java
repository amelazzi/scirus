...
public class DefaultViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return DataBaseEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case DataBaseEditPart.VISUAL_ID:
			return createDataBase_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CapteurEditPart.VISUAL_ID:
			return createCapteur_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case GateWayEditPart.VISUAL_ID:
			return createGateWay_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case CloudEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public Node createDataBase_2001(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createGateWay_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
