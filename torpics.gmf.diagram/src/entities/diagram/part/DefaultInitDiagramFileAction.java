 ...
 * @generated
 */
public class DefaultInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DefaultNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				NetworkEditPart.MODEL_ID));
		DefaultDiagramEditorUtil.runWizard(getShell(), wizard,
