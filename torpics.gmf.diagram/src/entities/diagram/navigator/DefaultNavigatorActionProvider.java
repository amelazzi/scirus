...
import entities.diagram.part.DefaultDiagramEditor;
 ...
 * @generated
 */
public class DefaultNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof DefaultNavigatorItem) {
					selectedElement = ((DefaultNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, DefaultDiagramEditor.ID);
