...
public class EntitiesPackageImpl extends EPackageImpl implements EntitiesPackage {
	 ...
	 * @generated
	 */
	public EReference getNetwork_DeviceList() {
	...
	public void createPackageContents() {
		...
		createEReference(networkEClass, NETWORK__DEVICE_LIST);
	...
	public void initializePackageContents() {
		...
		initEReference(getLink_Source(), this.getDevice(), null, "source", null, 1, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLink_Destination(), this.getDevice(), null, "destination", null, 1, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNetwork_DeviceList(), this.getDevice(), null, "deviceList", null, 0, -1, Network.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
