...
public interface EntitiesPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link entities.Network#getDeviceList <em>Device List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Device List</em>'.
	 * @see entities.Network#getDeviceList()
	 * @see #getNetwork()
	 * @generated
	 */
	EReference getNetwork_DeviceList();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference NETWORK__DEVICE_LIST = eINSTANCE.getNetwork_DeviceList();
