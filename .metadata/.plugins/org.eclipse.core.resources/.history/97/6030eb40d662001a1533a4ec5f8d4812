 ...
 * <ul>
 *   <li>{@link entities.Network#getDeviceList <em>Device List</em>}</li>
...
public interface Network extends EObject {
	 ...
	 * The list contents are of type {@link entities.Device}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see entities.EntitiesPackage#getNetwork_DeviceList()
