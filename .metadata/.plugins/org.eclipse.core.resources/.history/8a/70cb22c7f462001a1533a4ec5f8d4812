 ...
 * <ul>
 *   <li>{@link entities.impl.ObjectsImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectsImpl extends MinimalEObjectImpl.Container implements Objects {
	...
	protected EClass eStaticClass() {
		return EntitiesPackage.Literals.OBJECTS;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitiesPackage.OBJECTS__ID, oldId, id));
	}
